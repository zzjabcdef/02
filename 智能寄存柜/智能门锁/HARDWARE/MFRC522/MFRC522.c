...
{ 
	...
	GPIO_InitStructure.GPIO_Pin   = GPIO_Pin_0;						//RST引脚
	GPIO_Init(GPIOF, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin   = GPIO_Pin_12;							//SCK引脚
	GPIO_Init(GPIOF, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin   = GPIO_Pin_11;							//NSS引脚
	GPIO_Init(GPIOF, &GPIO_InitStructure);
	
	GPIO_InitStructure.GPIO_Pin   = GPIO_Pin_4;							//MOSI引脚
	GPIO_Init(GPIOF, &GPIO_InitStructure);
	
	
	GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_IN;			 			//输入模式
	GPIO_InitStructure.GPIO_Pin   = GPIO_Pin_2;							//MISO引脚
	GPIO_Init(GPIOF, &GPIO_InitStructure);										
}
