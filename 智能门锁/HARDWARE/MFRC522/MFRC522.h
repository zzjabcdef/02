...
#define MFRC522_CS(x) 	x ? GPIO_SetBits(GPIOF,GPIO_Pin_11) :GPIO_ResetBits(GPIOF,GPIO_Pin_11)
#define MFRC522_Rst(x) 	x ? GPIO_SetBits(GPIOF,GPIO_Pin_0):GPIO_ResetBits(GPIOF,GPIO_Pin_0)
#define MFRC522_MOSI(x) x ? GPIO_SetBits(GPIOF,GPIO_Pin_4) :GPIO_ResetBits(GPIOF,GPIO_Pin_4)
#define MFRC522_SCK(x) 	x ? GPIO_SetBits(GPIOF,GPIO_Pin_12) :GPIO_ResetBits(GPIOF,GPIO_Pin_12)
#define MFRC522_MISO	  GPIO_ReadInputDataBit(GPIOF,GPIO_Pin_2)
